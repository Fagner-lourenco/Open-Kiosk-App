...
export const NotificationTemplates = {
  ...
  lowStock: (productName: string, storeName: string, currentStock: number, threshold: number, storeId?: string) => ({
    ...
    title: 'Estoque Baixo',
    message: `${productName} est� com estoque baixo (${currentStock}/${threshold}) em ${storeName}`,
    storeName,
    storeId,
  ...
  esp32Disconnected: (storeName: string, storeId: string) => ({
    ...
    message: `O dispositivo ESP32 em ${storeName} perdeu conex�o`,
    storeId,
    storeName,
  ...
  esp32Reconnected: (storeName: string, storeId: string) => ({
    ...
    message: `O dispositivo ESP32 em ${storeName} est� online novamente`,
    storeId,
    storeName,
  }),
