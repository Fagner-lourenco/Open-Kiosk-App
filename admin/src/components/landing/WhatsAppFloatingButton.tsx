...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed right-4 bottom-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all hover:bg-green-600 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 animate-bounce"
